...
\input{preamble}        % shared typography, also used by the Markdown build
\usepackage{enumitem}
...
% Typos, wording, figure/table fixes, references. Order by the page on which
% each occurs; comments spanning the whole manuscript go first.
\begin{enumerate}
  \item
\end{enumerate}
