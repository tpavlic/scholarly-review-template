...
Notes on the literature, useful to both the reviewer and any assisting
agent when finalizing or re-reviewing. Record what a source says (facts,
not verdicts); the evaluation stays the reviewer's.

### Background on cited works

- Works the manuscript cites that I needed to read up on.
