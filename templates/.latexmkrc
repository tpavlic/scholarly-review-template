...
# -- from the command line or an editor such as VS Code's LaTeX Workshop -- finds
# it. latexmk reads ./.latexmkrc from its working directory and does NOT search
# parent folders, so a single config at the repository root would be missed when
